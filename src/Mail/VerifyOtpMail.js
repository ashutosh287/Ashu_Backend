...
exports.verifyOtp = async (name, email, randomOtp) => {
    ...
    const emailTemplate = {
        from: '"ishop" <your-email@gmail.com>',
        to: email,
        subject: "Email Verification OTP - ishop",
        html: `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                <div style="background-color: #16253D; padding: 30px; border-radius: 10px;">
                    <h1 style="color: #FF4500; margin: 0; padding-bottom: 20px;">Ishop</h1>
                        
                    <div style="background-color: #ffffff; padding: 30px; border-radius: 8px;">
                        <h2 style="color: #16253D; margin-top: 0;">Verify Your Email</h2>
                        <p style="color: #333333;">Hello ${name},</p>
                        <p style="color: #333333;">Thank you for signing up with Ishop. To verify your email address, please use the following verification code:</p>
                        ...
                        <ul style="color: #333333;">
                            ...
                            <li>If you didn't create an account with Ishop, please ignore this email</li>
                        </ul>
                        
                        <p style="color: #333333; margin-top: 20px;">Welcome aboard!<br>Team Ishop</p>
                    </div>
